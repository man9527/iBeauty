...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation TTStyledCaptionPhotoView
...
- (void)showCaption:(NSString*)caption {
    if (caption) {
        if (!_captionLabel) {
            ...
            _label1 = [[TTStyledTextLabel alloc] initWithFrame:CGRectMake(0, 100, 320, 300)];
            _label1.font = [UIFont systemFontOfSize:17];
            _label1.contentInset = UIEdgeInsetsMake(10, 10, 10, 10);
            _label1.backgroundColor = [UIColor clearColor];
            _label1.alpha = _hidesCaption ? 0:1;
            _label1.text = [TTStyledText textFromXHTML:caption lineBreaks:YES URLs:YES];
            [_label1 sizeToFit];
...
- (void)setHidesCaption:(BOOL)hidesCaption {
    ...
    _label1.alpha = hidesCaption ? 0 : 1;
}
